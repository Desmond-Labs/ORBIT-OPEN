-- ORBIT Database Enhancement Plan Implementation
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_orders_order_status ON public.orders(order_status);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_payments_stripe_payment_intent_id ON public.payments(stripe_payment_intent_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_payments_payment_status ON public.payments(payment_status);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_storage_buckets_user_id ON public.storage_buckets(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_storage_buckets_bucket_type ON public.storage_buckets(bucket_type);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_file_downloads_user_id ON public.file_downloads(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_file_downloads_access_token ON public.file_downloads(access_token);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_file_downloads_expires_at ON public.file_downloads(expires_at);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_batches_order_id ON public.batches(order_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_images_order_id ON public.images(order_id);
