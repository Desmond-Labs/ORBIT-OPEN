-- Fix calculate_hybrid_pricing to always pass 3 parameters to calculate_tier_pricing
...
BEGIN
    ...
    IF paid_images > 0 THEN
        -- Always pass 3 parameters to calculate_tier_pricing
        IF billing_period_start_param IS NULL THEN
            SELECT calculate_tier_pricing(user_id_param, paid_images, NULL) INTO paid_pricing;
        ELSE
