-- Remove unused tables and views from Orbit v2 database
-- These objects are not used by the current orbit-image-forge application

-- Drop views first
DROP VIEW IF EXISTS public.batch_processing_summary CASCADE;
DROP VIEW IF EXISTS public.service_health_summary CASCADE;
